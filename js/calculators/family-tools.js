...
const FamilyTools = {
  ...
  RATES_TIMELINE: [
    ...
    },
    {
      ...
      rateDescDe: "250 € pro Kind (Einheitssatz)",
    ...
    },
    {
      ...
      rateDescDe: "255 € pro Kind (+5 € Erhöhung)",
    ...
    },
    {
      ...
      rateDescDe: "267 € pro Kind (Regierungsentwurf / angekündigt / noch nicht verabschiedet)",
      ...
      statusDe: "Regierungsentwurf / angekündigt (noch nicht verabschiedet)",
    ...
    },
    {
      ...
      rateDescDe: "272 € pro Kind (Regierungsentwurf / angekündigt / noch nicht verabschiedet)",
  ...
  calculateKindergeld(numChildren, year = 2026) {
    ...
    if (targetYear === 2026) {
      ...
      return {
        ...
        messageDe: `Für das Jahr ${targetYear} liegen keine offiziellen Kindergelddaten vor. Gesetzlich verifizierte Jahre: 2021–2026 (2027–2028 sind Regierungsankündigungen).`,
