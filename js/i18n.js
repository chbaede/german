...
const I18N = {
  en: {
    ...
    incomeTax: "Estimated Lohnsteuer",
    estimatedLohnsteuer: "Estimated Lohnsteuer",
    payrollDisclaimerTitle: "Notice",
    payrollDisclaimer: "This is an estimate. Actual employer payroll withholding may differ.",
  ...
  ko: {
    ...
    incomeTax: "예상 근로소득세 (Estimated Lohnsteuer)",
    estimatedLohnsteuer: "예상 근로소득세 (Estimated Lohnsteuer)",
    payrollDisclaimerTitle: "안내",
    payrollDisclaimer: "본 계산 결과는 추정치입니다. 실제 고용주의 급여 원천징수액은 다를 수 있습니다.",
    solz: "연대특별세 / 통일세 (SolZ)",
