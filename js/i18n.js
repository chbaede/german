...
const I18N = {
  en: {
    ...
    pkvEstimatorTitle: "Private Health Insurance (PKV) Cost Estimator",
    pkvEstimatorNotice: "PKV premiums are risk- and age-based contract amounts, not calculated as a percentage of gross income.",
    pkvEmployerSubsidyLabel: "Employer Subsidy (Arbeitgeberzuschuss €/mo)",
  ...
  ko: {
    ...
    pkvEstimatorTitle: "민간 건강보험 (PKV) 견적 모드",
    pkvEstimatorNotice: "민간 건강보험(PKV)은 소득 비례 요율이 아니며, 개인별 연령 및 가입 플랜에 따른 고정 보험료가 적용됩니다.",
    pkvEmployerSubsidyLabel: "고용주 지원금 (Arbeitgeberzuschuss €/월)",
