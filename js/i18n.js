...
const I18N = {
  en: {
    ...
    careChildrenProofNote: "Children under age 25 may affect the employee Pflegeversicherung contribution. The contribution reduction requires eligibility/proof.",
  ...
  ko: {
    ...
    careChildrenProofNote: "만 25세 미만 자녀는 요양보험료(Pflegeversicherung) 감면 요건에 해당하며, 실제 급여 반영 시 증빙 제출이 필요합니다.",
