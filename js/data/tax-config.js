  ...
  taxClasses: [
    {
      ...
      useCaseDe: "Alleinstehende, geschiedene oder dauernd getrennt lebende Arbeitnehmer ohne kindergeldberechtigte Kinder.",
      ...
      featuresDe: "Voller gesetzlicher Grundfreibetrag (12.348 € in 2026), Arbeitnehmer-Pauschbetrag (1.230 €) und Vorsorgepauschale.",
      featuresKo: "2026년 법정 기본공제(12,348 €), 근로자 필요경비 공제(1,230 €) 및 사회보험료 공제 적용.",
      limitationsEn: "No spousal splitting advantages.",
      limitationsDe: "Keine Splitting-Vorteile.",
    ...
    },
    {
      ...
      useCaseDe: "Alleinerziehende, die mit mindestens einem kindergeldberechtigten Kind im gemeinsamen Haushalt leben.",
      ...
      featuresDe: "Enthält den Entlastungsbetrag für Alleinerziehende (4.260 €/Jahr für das erste Kind + 240 € je weiteres Kind).",
      ...
      limitationsDe: "Keine weiteren volljährigen Personen im Haushalt erlaubt.",
    ...
    },
    {
      ...
      useCaseDe: "Verheiratete oder eingetragene Lebenspartner, wenn ein Partner Alleinverdiener ist oder deutlich mehr verdient. Der Partner erhält Steuerklasse V.",
      ...
      featuresDe: "Doppelter Grundfreibetrag (24.696 € in 2026) führt zu geringerem monatlichen Steuerabzug für den Hauptverdiener. Die finale Steuerfestsetzung erfolgt über die gemeinsame Einkommensteuererklärung.",
      ...
      limitationsDe: "Partner in Steuerklasse V hat hohe Abzüge. Pflicht zur Abgabe einer Einkommensteuererklärung.",
    ...
    },
    {
      ...
      useCaseDe: "Verheiratete Doppelverdiener mit annähernd gleichem Einkommen. Gesetzlicher Standard nach der Heirat.",
      ...
      featuresDe: "Beide Partner werden steuerlich wie Steuerklasse I behandelt. Minimiert das Risiko von Steuernachzahlungen.",
      ...
      limitationsDe: "Keine unterjährige Steueroptimierung bei größeren Einkommensunterschieden (Ausgleich erfolgt erst per Steuererklärung).",
    ...
    },
    {
      ...
      useCaseDe: "Verheirateter Partner, dessen Ehegatte die Steuerklasse III gewählt hat.",
      ...
      featuresDe: "Ermöglicht dem Partner in Steuerklasse III die Inanspruchnahme beider Grundfreibeträge.",
      ...
      limitationsDe: "Kein Grundfreibetrag (0 €) – Besteuerung ab dem ersten Euro. Pflicht zur Abgabe der Steuererklärung.",
    ...
    },
    {
      ...
      useCaseDe: "Zweites und jedes weitere Dienstverhältnis (Nebenjob / Mehrfachbeschäftigung).",
      ...
      featuresDe: "Gilt ausschließlich für Nebenbeschäftigungen; der Hauptjob behält die Freibeträge in der Erststeuerklasse.",
      ...
      limitationsDe: "Keinerlei Freibeträge (weder Grundfreibetrag noch Pauschbeträge). Besteuerung ab dem ersten Euro.",
